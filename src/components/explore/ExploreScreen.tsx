...
export function ExploreScreen({ onOpenPlace }: Props) {
  ...
  return (
    <View style={styles.root}>
      ...
      {mode === 'map'
        ? <ExploreMap places={places} selectedPlaceId={selectedPlace?.id} onSelectPlace={setSelectedPlace}/>
