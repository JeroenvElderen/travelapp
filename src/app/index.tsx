...
export default function IndexRoute() {
  ...
  if (tab === 'Move') return <MovingAbroadScreen onTabChange={setTab} onOpenCountry={openGuide} onOpenVisa={() => setTab('VisaExplorer')} onOpenComparison={() => setTab('CityComparison')} />;
