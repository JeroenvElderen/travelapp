...
export const places: Place[] = [
  {id:'1',name:'Plitvice Lakes',country:'Croatia',rating:4.9,image:'https://images.unsplash.com/photo-1555990538-c48ac0b6fbd4?w=700'},
  {id:'2',name:'Lake Braies',country:'Italy',rating:4.8,image:'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=700'},
  {id:'3',name:'Santorini',country:'Greece',rating:4.9,image:'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=700'},
  {id:'4',name:'Kelingking Beach',country:'Indonesia',rating:4.8,image:'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=700'}];
